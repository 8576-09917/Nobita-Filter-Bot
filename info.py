...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1947565279').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1947565279').split()]
...
STREAM_BIN = environ.get("STREAM_BIN", "-1001919010755") #Log channel
STREAM_URL = environ.get("STREAM_URL", "https://streamingss-0095ac4819cd.herokuapp.com/")
